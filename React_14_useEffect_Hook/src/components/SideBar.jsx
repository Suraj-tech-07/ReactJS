const SideBar = ({ resetTab, currentTab }) => {
    ...
    return (
        <>
            <div className="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style={{ width: '280px', height: '100vh', position: 'fixed', top: '0', left: '0' }}>
